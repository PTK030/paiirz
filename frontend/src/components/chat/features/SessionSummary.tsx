...
function StatCard({ icon, iconBg, label, value, suffix, valueColor = "text-white", sub }: StatCardProps) {
  return (
    <div className="bg-zinc-950/40 border border-zinc-900 rounded-2xl p-4 shadow-lg flex flex-col gap-3">
      ...
      <div className="pl-0.5">
        ...
        {sub && (
          <p className="text-[10px] text-zinc-600 mt-1 font-medium leading-relaxed">{sub}</p>
        )}
      </div>
    </div>
  );
