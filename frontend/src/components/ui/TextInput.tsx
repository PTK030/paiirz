...
/**
 * @description Shared text input primitive with consistent neo-glass styling
 * and an optional label. Renders a `<textarea>` when `multiline` is `true`,
 * otherwise a native `<input>`; forwards its ref to the underlying element.
 */
